...
\end{verbatim}
 ...
 Note, however, that some people may have obtained a different result. For example, with a slight change to the {\texttt{props.txt}} file, I get 
\begin{verbatim}
     font     color font-size       <NA> 
  "Times"     "red"      "12"        NA 
\end{verbatim}
